...
import { STAGES, EVENT_TYPES, INITIAL_STAGES } from '@/constants/pipeline'
...
export function useReview() {
  ...
  function connectSSE() {
    ...
    sse = useSSE(eventsUrl.value, {
      ...
      error(e) {
        const isFatal = e?.recoverable === false
        if (isFatal) {
  ...
  return {
    appState, inputMode, taskId, eventsUrl, resultUrl,
