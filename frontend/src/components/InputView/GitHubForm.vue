...
<template>
  <form @submit.prevent="handleSubmit" class="space-y-4">
    ...
    <p class="text-xs text-slate-400">
      ...
      <a href="https://github.com/settings/tokens" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:underline">Generate one</a>
    </p>
    ...
    <button type="submit" :disabled="loading"
      ...
      {{ loading ? 'Fetching & Analyzing...' : 'Start Review' }}
    </button>
  </form>
</template>
